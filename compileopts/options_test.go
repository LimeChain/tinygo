...
func TestVerifyOptions(t *testing.T) {
	...
	expectedGCError := errors.New(`invalid gc option 'incorrect': valid values are none, leaking, extallocleak, conservative, custom, precise`)
